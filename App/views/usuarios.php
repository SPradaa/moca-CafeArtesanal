...
<head>
    ...
    <title>Moca-Cafe Artesanal</title>
...
<body>
    <header class="header">
        <section class="logo">
            <img src="./Assets/Images/logo.png" alt="Logo Cafe Artesanal" class="imagen-logo">
            <div class="logo-texto">
                <h4 class="moca">Moca</h4>
                <p class="cafe-artesanal">Cafe Artesanal</p>
            </div>
        </section>
        <section class="navegacion">
            <a href="index.php?ruta=favoritos">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
                    <path fill="#ffffff" d="M20.16 5A6.29 6.29 0 0 0 12 4.36a6.27 6.27 0 0 0-8.16 9.48l6.21 6.22a2.78 2.78 0 0 0 3.9 0l6.21-6.22a6.27 6.27 0 0 0 0-8.84m-1.41 7.46l-6.21 6.21a.76.76 0 0 1-1.08 0l-6.21-6.24a4.29 4.29 0 0 1 0-6a4.27 4.27 0 0 1 6 0a1 1 0 0 0 1.42 0a4.27 4.27 0 0 1 6 0a4.29 4.29 0 0 1 .08 6Z" />
                </svg></a>
            <a href="index.php?ruta=carrito">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
                    <path fill="#ffffff" d="M16 18a2 2 0 0 1 2 2a2 2 0 0 1-2 2a2 2 0 0 1-2-2a2 2 0 0 1 2-2m0 1a1 1 0 0 0-1 1a1 1 0 0 0 1 1a1 1 0 0 0 1-1a1 1 0 0 0-1-1m-9-1a2 2 0 0 1 2 2a2 2 0 0 1-2 2a2 2 0 0 1-2-2a2 2 0 0 1 2-2m0 1a1 1 0 0 0-1 1a1 1 0 0 0 1 1a1 1 0 0 0 1-1a1 1 0 0 0-1-1M18 6H4.27l2.55 6H15c.33 0 .62-.16.8-.4l3-4c.13-.17.2-.38.2-.6a1 1 0 0 0-1-1m-3 7H6.87l-.77 1.56L6 15a1 1 0 0 0 1 1h11v1H7a2 2 0 0 1-2-2a2 2 0 0 1 .25-.97l.72-1.47L2.34 4H1V3h2l.85 2H18a2 2 0 0 1 2 2c0 .5-.17.92-.45 1.26l-2.91 3.89c-.36.51-.96.85-1.64.85" />
                </svg></a>
            <section>
    ...
    <main class="main">
        <div class="banner">
            <img src="./Assets/Images/principalBanner/banner1.png" alt="Banner Cafe Artesanal" class="imagen-banner active">
            <img src="./Assets/Images/principalBanner/banner2.png" alt="Banner Cafe Artesanal" class="imagen-banner">
            <img src="./Assets/Images/principalBanner/banner3.png" alt="Banner Cafe Artesanal" class="imagen-banner">
            <img src="./Assets/Images/principalBanner/banner4.png" alt="Banner Cafe Artesanal" class="imagen-banner">
            <img src="./Assets/Images/principalBanner/banner5.png" alt="Banner Cafe Artesanal" class="imagen-banner">
        </div>
